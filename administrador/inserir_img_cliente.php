...
/*if( $_SERVER['REQUEST_METHOD']=='POST' ){*/
 ...
 if (isset($_FILES['arquivo'])) {
  ...
  $caminho_absoluto = 'web/clientes/img-clientes/';
...
<div class="container-imagem-formulario">
 ...
 <img src="http://www.mestremoveleiro.com.br/clientes/img-clientes/<?php echo $caminho_img; ?>" alt="" style="width: 300px; height: 300px; background: #d4d4d4; "><br><p></p>
</div>
