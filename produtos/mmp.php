...
<head>
<meta charset="UTF-8">
<title><?php echo utf8_encode ($carrega_dadosEmpresa['nome'])?> | <?php echo utf8_encode ($carregar_produto["nome"]); ?></title>
...
<meta property="og:title" content="<?php echo utf8_encode ($carrega_dadosEmpresa['nome'])?> | <?php echo utf8_encode ($carregar_produto["nome"]); ?>" />
<meta property="og:description" content="<?php echo utf8_encode ($carregar_produto["descricao_produto"]); ?>" />

<meta property="og:url" content="http://www.mestremoveleiro.com.br/produtos/mmp?<?php echo utf8_encode (str_replace (" ", "-",$carregar_produto["nome"])); ?>&produto=<?php echo utf8_encode ($carregar_produto["id"]); ?>" />

<meta property="og:site_name" content="<?php echo utf8_encode ($carrega_dadosEmpresa['nome'])?>" />

<meta name="keywords" content="<?php echo utf8_encode ($carregar_produto["keywords"])?>">
