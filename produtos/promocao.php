...
$listar = "SELECT * FROM loja_produtos WHERE categoria_promocao = 'sim' ORDER BY nome ASC";
...
if (isset($_GET['ordem'])) {
  ...
  $listar = "SELECT * FROM loja_produtos WHERE categoria_promocao = 'sim' ORDER BY preco ASC";
  $resultado_listar = mysqli_query($conn, $listar);
  ...
  $listar = "SELECT * FROM loja_produtos WHERE categoria_promocao = 'sim' ORDER BY preco DESC";
  $resultado_listar = mysqli_query($conn, $listar);
...
<head>
<meta charset="UTF-8">
<title><?php echo utf8_encode ($carrega_dadosEmpresa['nome'])?> | Produtos em Promoção</title>
...
<meta property="og:title" content="<?php echo utf8_encode ($carrega_dadosEmpresa['nome'])?> | Produtos em Promoção" />
<meta property="og:description" content="<?php echo utf8_encode ($carrega_dadosEmpresa['sobre_empresa'])?>" />
<meta property="og:url" content="http://www.mestremoveleiro.com.br/produtos/promocao"/>
...
<div class="container-produtos">
  ...
  <div class="titulo-container-produtos" style="width: 100%; float: left;">
    <p style="float: left; font-size: 28px !important; color: #666666; margin-left: 10px; margin-right: 10px;">Produtos em Promoção</p>
     ...
     <div class='category_listfiltro'>
          ...
          <div class='dropdown-contentfiltro'>
            ...
            <a href='/produtos/promocao?ordem=alfabetica'>Ordem alfabética</a>
            <a href='/produtos/promocao?ordem=menor-preco'>Menor preço</a>
            <a href='/produtos/promocao?ordem=maior-preco'>Maior preço</a>                   
